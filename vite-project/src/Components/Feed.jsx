...
const Feed = () => {
  return (
    <div className="max-w-lg bg-gray-100 rounded mx-auto px-5 py-2">
      ...
      <h5>Bhubneswar</h5>
      <div className="bg-gray-50 py-4 px-2 rounded">
        <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga eius obcaecati quas earum expedita alias aliquid nulla deserunt, modi eligendi, doloribus eum a?</div>
      ...
      <div className="">
        <button className="ml-auto bg-blue-400 px-6 py-2 block">JOIN</button>
      </div>
    </div>
  );
};
